...
<table class="easyui-datagrid" id="awaitAllotOrderList" title="待分配催收订单列表"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/get/urge/order/list.do?state=10',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
        <tr>
...
<script>
    ...
    function getSelectionsIds(){
    	var itemList = $("#awaitAllotOrderList");
                ...
                success : function(data) {//返回数据根据结果进行相应的处理
                    ...
                    if (data.code==200){
                        $.messager.alert('提示',data.msg,undefined,function(){
                            $("#awaitAllotOrderList").datagrid("reload");
                        });
                    }else{
                        $.messager.alert('提示',data.msg,undefined,function(){
                            $("#awaitAllotOrderList").datagrid("reload");
